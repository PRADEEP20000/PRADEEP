...
<body>
  ...
  <div class="imgcontainer">
    ...
    <label for="uname"><b>Username</b></label>
      <asp:TextBox ID="txtname"  placeholder="Enter Username" class="form-control" runat="server"></asp:TextBox><br ><br />
   

    <label for="psw"><b>Password</b></label>
      <asp:TextBox ID="txtpassword" placeholder="Enter Password" class="form-control"  runat="server"></asp:TextBox><br><br />
